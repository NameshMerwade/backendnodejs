        ...
        if (!err) {
            if (results.length <= 0) {
                ...
                var mailOption = {
                    ...
                    html: '<p><b>Your Login details for cafe Managment System</b><br><b>Email: </b>' + results[0].email + '<br> <b>Password: </b>' + results[0].password + '<br> <a href="http://localhost:4200/">Click here to Login</a></p>'
                };
